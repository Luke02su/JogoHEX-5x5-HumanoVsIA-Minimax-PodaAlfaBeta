...
<p style="text-align: left; margin: 0;">Notou-se, para tabuleiros maiores, como 7x7, 9x9, 11x11, uma demora bastante acentuada para profundidades mais altas, como a de 4. Portanto, com isso, preferiu-se não ser testado em profundidades maiores, bem como manter o tabuleiro em 5x5, seguindo, assim, às recomendações da professora para se garantir a otimidade sem custar tempo de processamento para obtê-la.</p>
